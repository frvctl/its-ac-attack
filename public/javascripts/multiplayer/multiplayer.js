...
(function() {
  var actionMode, addAnnotation, avg, changeQuestion, chatAnnotation, computeScore, createBundle, cumsum, generateName, guessAnnotation, last_question, latency_log, public_name, renderPartial, renderState, renderTimer, serverTime, setActionMode, sock, stdev, sync, sync_offset, sync_offsets, testLatency, time, userSpan, users,
  ...
  renderState = function() {
    ...
    if (sync.users) {
      ...
      _ref2 = sync.users.sort(function(a, b) {
        return computeScore(b) - computeScore(b);
      });
